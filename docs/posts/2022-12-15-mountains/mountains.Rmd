...
An obvious approach would be to make a relief map, with colors corresponding to elevation, but to make it more interesting I decided to create a more stylized ridgeline-style map. A ridge plot is... hard to describe. Look up the album cover of [Joy Division's *Unknown Pleasures*](https://en.wikipedia.org/wiki/Unknown_Pleasures) and you'll understand. I am indebted to dieghernan's [tutorial](https://dieghernan.github.io/202205_Unknown-pleasures-R/) on mapping with ridgelines.^[And let me just say that learning to make maps in `R` has been bewilderingly difficult. I have found [*Geocomputation with R*](https://geocompr.robinlovelace.net/) useful, but much of it remains mysterious to me.]
...
```{r echo=FALSE}
knitr::include_graphics("nagpatong.jpg")
```
